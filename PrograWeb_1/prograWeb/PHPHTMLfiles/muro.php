<!--
Interfaz que muestra todas las publicaciones de todos los usuario
al usuario actual.
-->
<?php
    session_start();
...
<html>
    ...
    <body onload="cargarPublicaciones(); autocompletadoLenguajes();">
        <div class="navbar navbar-default">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="#">Foro</a></li>
        ...
        <div class="row" align="center">
            <div class="col-xs-6 col-sm-4 panel-footer">
                <form id="publicar" class="form-horizontal" action="javascript:publicarMuroAux()" methos="POST">
                        <fieldset>
                        <!-- Form Name -->
            ...
            <div  class="col-xs-6 col-sm-6  panel-footer">
                ...
                <div  id="capaActualizableMuroAux">
                    
                </div>
            </div>
        </div>
        
        <div class="modal fade" id="modalComentar" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div>
                            <div align="left">
                                <form class="form-horizontal" action="javascript:realizarComentario()" methos="POST">
                                    <div class="form-group">
