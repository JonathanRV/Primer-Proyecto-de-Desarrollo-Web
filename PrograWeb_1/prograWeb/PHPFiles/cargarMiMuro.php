<!--/
Documento PHP que cargar desde base de datos las publicaciones de un usuario
en su propio muro.
/-->
<?php
    session_start();
    if (isset( $_SESSION["nombreUsuario"]))
    {
        ...
        for(;$fila= pg_fetch_assoc($result2);){ 
            ...
            $idUsua = pg_field_name($result2,4);
             ...
             echo "<div class=\"form-group\">
                ...
                <div class=\"form-group\">
                    ...
                    <div class=\"col-md-5\">
                        <label class=\"col-md-4 control-label\">$fila[$descrip]</label>
                    </div>
                </div>
                <div class=\"form-group\">
            ...
            echo "<button id=\"$fila[$idPubli]\" type=\"button\" class=\"btn btn-success\" data-toggle=\"modal\" data-target=\"#modalComentarMiMuro\" onclick = \"idPublicComentario(this)\">Comentar</button>
                </div>"
                 . "<hr style=\"color: #555\">";
         }
         echo "</fieldset></form>";
